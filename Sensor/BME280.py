...
class BM280_GY39(Sensor):
    ...
    def get_sample(self):
      try:
        ...
        return temperature, pressure, humidity, self._unit
    ...
    def readBME280ID(self):
      ...
      REG_ID     = 0xD0
      (chip_id, chip_version) = self._bus.read_i2c_block_data(self._addr, REG_ID, 2)
    ...
    def readBME280All(self):
      ...
      OVERSAMPLE_HUM = 2
      self._bus.write_byte_data(self._addr, REG_CONTROL_HUM, OVERSAMPLE_HUM)

      control = OVERSAMPLE_TEMP<<5 | OVERSAMPLE_PRES<<2 | MODE
      self._bus.write_byte_data(self._addr, REG_CONTROL, control)

      # Read blocks of calibration data from EEPROM
      # See Page 22 data sheet
      cal1 = self._bus.read_i2c_block_data(self._addr, 0x88, 24)
      cal2 = self._bus.read_i2c_block_data(self._addr, 0xA1, 1)
      cal3 = self._bus.read_i2c_block_data(self._addr, 0xE1, 7)
      ...
      data = self._bus.read_i2c_block_data(self._addr, REG_DATA, 8)
